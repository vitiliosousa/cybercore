...
const initialProjects: Project[] = [
  {
    ...
    tasks: [
      { id: "t1", title: "Design neural layer architecture", description: "", status: "done", priority: "high", assignee: "Sarah Jenkins", dueDate: "2026-04-20", tags: ["architecture"] },
      { id: "t2", title: "Implement data pipeline", description: "", status: "in_progress", priority: "high", assignee: "David Chen", dueDate: "2026-04-28", tags: ["backend"] },
      { id: "t3", title: "Write unit tests for core module", description: "", status: "todo", priority: "medium", assignee: "Elena Rodriguez", dueDate: "2026-05-02", tags: ["testing"] },
      { id: "t4", title: "Performance benchmarking", description: "", status: "review", priority: "critical", assignee: "Sarah Jenkins", dueDate: "2026-05-04", tags: ["performance"] },
    ],
  },
  {
    id: "2",
    ...
    tasks: [
      { id: "t5", title: "Audit current codebase", description: "", status: "done", priority: "high", assignee: "Mike Ross", dueDate: "2026-04-15", tags: ["audit"] },
      { id: "t6", title: "Define microservices boundaries", description: "", status: "in_progress", priority: "high", assignee: "Anya Patel", dueDate: "2026-04-25", tags: ["architecture"] },
      { id: "t7", title: "API gateway setup", description: "", status: "todo", priority: "medium", assignee: "Mike Ross", dueDate: "2026-04-27", tags: ["backend"] },
    ],
  },
  {
    id: "3",
    ...
    tasks: [
      { id: "t8", title: "Security threat modelling", description: "", status: "in_progress", priority: "critical", assignee: "Elena Rodriguez", dueDate: "2026-05-01", tags: ["security"] },
      { id: "t9", title: "Edge node provisioning scripts", description: "", status: "todo", priority: "high", assignee: "James Liu", dueDate: "2026-05-10", tags: ["infra"] },
    ],
  },
];
