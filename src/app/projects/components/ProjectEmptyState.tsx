...
export const ProjectEmptyState = ({ search, onClearSearch, onNewProject }: ProjectEmptyStateProps) => {
  return (
    <div className="flex flex-col items-center justify-center py-24 text-center">
      ...
      <p className="text-white font-semibold text-sm mb-1">Nenhum projecto encontrado</p>
      <p className="text-text-muted text-[12px]">
        {search ? `Sem resultados para "${search}"` : "Cria o teu primeiro projecto para começar"}
      </p>
      {search ? (
        <button
